...
def parse_args():
    ...
    parser.add_argument("--upscale_factor", type=int, default=7, help="upscale factor")
    parser.add_argument('--testset_dir', type=str, default='/mnt2/dataset/LFASR_data//TestData_SIG_2x2_ASR_7x7/')#TestData_SIG_2x2_ASR_7x7  TestData_HCI_2x2_ASR_7x7
    ...
    parser.add_argument('--model_path', type=str, default='../checkpoint_SIG_best/ASRNet_2x2xSR_7x7_epoch_80.pth.tar')
