...
def parse_args():
    ...
    parser.add_argument('--trainset_dir', type=str, default='/mnt2/dataset/LFASR_data/TrainingData_HCIori_2x2_ASR_7x7/')#TrainingData_SIG_2x2_ASR_7x7  TrainingData_HCIori_2x2_ASR_7x7
    parser.add_argument('--testset_dir', type=str, default='/mnt2/dataset/LFASR_data//TestData_HCI_2x2_ASR_7x7/')#    TestData_SIG_2x2_ASR_7x7   TestData_HCI_2x2_ASR_7x7

    parser.add_argument('--batch_size', type=int, default=4)
    parser.add_argument('--lr', type=float, default=2e-4, help='initial learning rate')##1e-4,25 for LFEASR
    ...
    parser.add_argument('--model_path', type=str, default='../checkpoint/ASRNet_2x2xSR_7x7_epoch_71.pth.tar')
...
def main(cfg):
    ...
    train_loader = DataLoader(dataset=train_set, num_workers=16, batch_size=cfg.batch_size, shuffle=True)
