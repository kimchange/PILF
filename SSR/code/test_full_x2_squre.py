...
def parse_args():
    ...
    parser.add_argument('--testset_dir', type=str, default='../data_for_training/TestData_2xSR_5x5/')
    ...
    parser.add_argument('--save_path', type=str, default='../TestResultsx2-full-pad8ifLytro-ep60/')
